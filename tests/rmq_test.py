...
class RMQTestSuite(unittest.TestCase):
    def test_successful_connection(self):
        ...
        rmq = RMQ()
        self.assertTrue(rmq.channel.is_open)
    ...
    def test_produce_single_message():
        ...
        result = rmq.send_message(test_message)
    ...
    def test_consume_single_message():
        ...
        start_time = time.perf_counter()
        rmq.send_message(test_message)
        retrieved_chats = rmq.recieve_messages(5)
    ...
    def test_produce_multiple_messages():
        ...
        for message in test_messages:
            result = rmq.send_message(message)
            assert result["result"] == "ENQUEUED"
        elapsed_time = time.perf_counter() - start_time
    ...
    def test_consume_multiple_messages():
        ...
        retrieved_messages = rmq.recieve_messages(10)
        for message in test_messages:
    ...
    def test_publish_to_private_channel(self):
        """
        Test that RMQ server can connect to private queue
        """
        start_time = time.perf_counter()
    ...
    def test_consume_from_private_channel(self):
        """
        Test that RMQ server can connect to private queue
        """
        start_time = time.perf_counter()
        ...
        test_message = "Test message for my private channel. Go Away!"
        rmq.send_message(test_message)
        recieved_messages = rmq.recieve_messages()
